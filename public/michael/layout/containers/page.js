import { Page, p, div, style, code } from "/app.js";
...
function inject(){
	...
	style(`
		...
		/* col is the container name set on .col-body in Page.css */
...
export default new Page({
	...
	content(){
		...
		p("Media queries ask how wide the *screen* is. Container queries ask how wide the *parent* is — so one component adapts anywhere you drop it. Each column body here is a query container (`container-type: inline-size; container-name: col` in `Page.css`).");
