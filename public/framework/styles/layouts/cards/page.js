...
then divides the space evenly. Resize the window: the count changes and nothing was
...
column, not a share of a grid.`);
				...
				recipe(this, "`pad` keeps the inset and drops the measure. The wall itself is one utility class.");
			});
