...
export default new Page({
	...
	content(){
		...
		md("`base` is the floor. What things actually *look* like starts one layer up — [theme](/framework/styles/layers/theme/).");

		md("Next: [theme](/framework/styles/layers/theme/) — tokens, the type scale, and the layer a theme replaces.");
	}
});
