...
/* Container: a plain page under `styles/system/studies/`, same as every sibling study
   (moved from `/imagine/design/` 2026-09-18). Size: `full` — a study is a report, and previous studies all took the
...
const CRAMPED = [
	...
	["/imagine/layouts/, /imagine/codrops/, /imagine/scenes/, /imagine/youtube/, /framework/styles/system/studies/padding/ (control)", "10.8px", "13px", "1.20×"],
