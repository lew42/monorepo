...
export default new Page({
	...
	content(){
		md("**One declaration, every framed box:** `padding: clamp(0.75em, 3.5cqi, 2.5em)` — the [padding study](/framework/styles/system/studies/padding/)'s comfortable band (2%–12% of a box's own width) said out loud as CSS. The `%` is `cqi` — the box's own slot, not the viewport — so a chip in a wide bar and a band on a phone both stay sane.");
