...
export default new Page({
	...
	content(){
		...
		// The levels are only half of typography; the other half is what a piece of text is
		// doing next to the text around it. That is one click down.
		p(() => {
			a("The repeated anchor").href(here + "anchors/");
			span(" — the same post three ways, to settle which little mark after a heading the eye actually finds, and why the higher-contrast one loses.");
		});
