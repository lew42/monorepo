...
export default new Page({
	...
	children: "sidebar-repair verify-server verify-assistant verify-dashboard verify-design verify-devbar v3-data health-revive system-eval inbox-zero health-triage card-adopt health-quiet hold-guard timing-audit-2 improvements-sweep skills-shrink reset-recovery reset-restore reset-deep",
