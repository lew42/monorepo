# capture-a — shoot, scan, look at and tag 16 websites (Sonnet, group `websites`)
...
|---|---|---|---|---|
| `github-vscode-repo` | https://github.com/microsoft/vscode | app | 2-sidebar | blocked |
| `hacker-news-home` | https://news.ycombinator.com/ | app | 1-flow | blocked |
| `astral-codex-ten-home` | https://www.astralcodexten.com/ | blog | 1-centered | allowed |
| `kent-c-dodds-blog` | https://kentcdodds.com/blog | blog | 3-cards | blocked |
| `smashing-magazine-home` | https://www.smashingmagazine.com/ | blog | 3-cards | blocked |
| `python-docs-index` | https://docs.python.org/3/ | docs | 2-sidebar | allowed |
| `vuejs-guide-intro` | https://vuejs.org/guide/introduction.html | docs | 3-holy-grail | allowed |
| `mocean-home` | https://moceanla.com/ | gallery-find | 1-flow | allowed |
| `waabi-home` | https://waabi.ai/ | gallery-find | 1-flow | allowed |
| `framer-home` | https://www.framer.com | marketing | 1-centered | blocked |
| `vercel-home` | https://vercel.com | marketing | 1-centered | blocked |
| `bbc-news-home` | https://www.bbc.com/news | news | 2-sidebar | blocked |
| `verge-home` | https://www.theverge.com | news | 2-sidebar | allowed |
| `ikea-home` | https://www.ikea.com/us/en/ | shop | 3-cards | allowed |
| `carbon-design-home` | https://carbondesignsystem.com/ | system | 2-sidebar | allowed |
| `salesforce-lightning-home` | https://www.lightningdesignsystem.com/ | system | 2-sidebar | blocked |
...
At the end, one headless pass over all your sites' pages at 1280 (`http://localhost:8123/websites/<name>/`): zero console errors, the four pictures present. A 20-line probe in the scratchpad named `capture-a-check.mjs` (the Playwright import is in the rules).

## Fences and budget

Write ONLY `public/websites/site/<name>.json` and `public/websites/site/<name>/` for the names in YOUR table, `public/websites/site/index.json` through `index.mjs`, this dir, and scratch named `capture-a-*`. Never edit the tools, the pages, `layouts.json`, or a sibling's site. `:8123` serves the site; no server of your own. Budget ~350k tokens; if you reach 300k with sites left, land what is done and list the rest — a finished half beats a torn whole. Report in ≤ 10 plain lines: done / failed (with why), the three most interesting layouts with their urls, the tags you had to invent, where the scan and the picture disagreed.
