...
const wrapping = () => div.c("surface pad flex wrap gap v-center", row).style("--gap", "calc(var(--gap) * 0.3)");

const scrolling = () => div.c("surface pad flex gap v-center", row)
	.style({ "--gap": "calc(var(--gap) * 0.3)", flexWrap: "nowrap", overflowX: "auto" });
