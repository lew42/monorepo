...
export default new Page({
	...
	content(){
		...
		md("**There is no `ui.card()`, and there is no `.ui-card` either.** The function was one `div.c()` with five class names in it; the class was styled by nothing. Both were a second name for `surface pad flex v gap`, which is already the sentence you would write.");
