...
/**
 * web(root) — the shared sample tree: one fictional site, rendered many ways.
 *
 *     demo.app(web())                                  // the default wall
 *     demo.app(web({ initialize(){ this.catalog(); } }))  // the same nine, rearranged
 *
