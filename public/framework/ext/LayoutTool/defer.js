/* "these cases of could-be-off could be deferred to the user" (Mike).
 *
 * A judgement call the reader has already made should not keep costing score
 * every time the audit runs. Deferring is per url + rule + selector, kept in
 ...
 * a matter of taste, and letting it be dismissed would make the score a
 * measure of how much has been waved through. */

const KEY = "lt-deferred";
