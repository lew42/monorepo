...
including why chips and a `<select>` coexist: [`doc/vocabulary.md`](./doc/vocabulary.md).
...
self-limiting width clamp and why it's `rem` not `em`: [`doc/drawer.md`](./doc/drawer.md).
...
including why the panel is not a DOM inspector: [`doc/selection.md`](./doc/selection.md).
...
[`doc/controls.md`](./doc/controls.md).
...
[`doc/vocabulary.md`](./doc/vocabulary.md) now; summarized above.

**The drawer pushes, not floats** — weighed against wrapping every page in a row
div and against making `.app` a grid. [`doc/drawer.md`](./doc/drawer.md) has the
full comparison and what's load-bearing in the CSS.

**What is selectable, and page-vs-container words** — [`doc/selection.md`](./doc/selection.md).
