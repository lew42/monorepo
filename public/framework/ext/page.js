...
export default new Page({
	...
	icon: "extension",
	children: "markdown demo highlight files toc Doc tabs catalog layout drawer grip Dropdown depth DesignTool Saver Draggable editor Panel Playground Timeline AITask JSONL Research Ask",
