...
export default new Page({
	...
	icon: "extension",
	children: "markdown demo highlight files toc Doc tabs catalog layout drawer grip Dropdown Omnibox depth DesignTool Saver Draggable editor Panel Timeline AITask JSONL Research Ask",
