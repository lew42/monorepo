...
--measure: 52em;`,
		...
		see: `Widescreen: [Reading grid](${LIB}reading-grid/). The don't: [Prose with no ceiling](${LIB}bad/prose-with-no-ceiling/). The measurement: [Characters per line](/framework/ext/DesignTool/knowledge/characters-per-line/).`,
		build(){
...
.metric { font-variant-numeric: tabular-nums }`,
		...
		see: `The tool's own report is one of these. Wider items belong in a [Dashboard row](${LIB}dashboard-row/). Why the near-misses: [Padding is not a misalignment](/framework/ext/DesignTool/knowledge/padding-is-not-a-misalignment/).`,
		build(){
		...
		build(){
			div.c("flex v gap").style("--gap", "0.5em").append(() =>
				[["probe.js", "the browser read, in one walk", "9.1 kB"], ["rules.js", "the geometry that fails", "12.0 kB"],
					["polish.js", "what is off rather than broken", "13.0 kB"], ["score.js", "weights, the census, page metrics", "3.4 kB"],
