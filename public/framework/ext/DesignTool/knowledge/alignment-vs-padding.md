...
|---|---|---|---|
| [Stat strip](/framework/ext/DesignTool/library/stat-strip/) | 400 | 6 × `med/alignment` | **11.2px** — the tile's `0.8em` |
| [List and detail](/framework/ext/DesignTool/library/list-and-detail/) | 400–3440 | 16–20 × `med/alignment` | **9.4px** — the row's `0.6em` |
