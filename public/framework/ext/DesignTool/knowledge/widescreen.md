...
|---|---|---|
| [Tile wall](/framework/ext/DesignTool/library/tile-wall/) | **88%** | clean — the track count is a consequence of the width |
| [Dashboard row](/framework/ext/DesignTool/library/dashboard-row/) | **75%** | clean — the row stays a row, its inside has places |
| [Reading grid](/framework/ext/DesignTool/library/reading-grid/) | **83%** | clean — three bounded reading columns |
| [Rail and content](/framework/ext/DesignTool/library/rail-and-content/) | 18% | `med` — two regions cannot fill a mega monitor |
| [Reading column](/framework/ext/DesignTool/library/reading-column/) | 27% | `med` — one column, and it is the house default |
| [Fixed-track wall](/framework/ext/DesignTool/library/bad/fixed-track-wall/) | 28% | `med` — a pixel track decided the viewport |
