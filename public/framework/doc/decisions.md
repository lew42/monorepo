# Framework — decisions and record
...
Long form: `./injection.md` (why nothing under `framework/` reads `window.app`),
`./theme-behaviour.md` (can a theme carry behaviour?), `./docs-system.md`
(what a doc page is made of), `./reachability.md` (the crawl + audit method, and
...
convenience only**; nothing under `framework/` may read it. `./injection.md`.
...
with lifecycle hooks. `./theme-behaviour.md`.
...
*which member*, the toc is *which section*. `./docs-system.md`.
