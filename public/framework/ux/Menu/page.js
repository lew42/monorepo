...
const words = () => div.c("flex v gap-2em", () => {
	div.c("flex v gap", () => { div.c("h4 muted", "default"); picker(); }).style("--gap", "calc(var(--gap) * 0.5)");
	div.c("flex v gap", () => { div.c("h4 muted", "ui-contrast ui-compact"); picker().ac("ui-contrast ui-compact"); }).style("--gap", "calc(var(--gap) * 0.5)");
});
