...
const words = () => div.c("flex v gap-2em", () => {
	div.c("flex v gap").style("--gap", "calc(var(--gap) * 0.5)").append(() => { div.c("h4 muted", "default"); course(); });
	div.c("flex v gap").style("--gap", "calc(var(--gap) * 0.5)").append(() => { div.c("h4 muted", "ui-contrast ui-compact"); course().ac("ui-contrast ui-compact"); });
});
