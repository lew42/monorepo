...
export default new AuditDoc({
	...
	notes: `core-View core-Page core-App core-Router core-Sidebar core-Item-List core-new
	        ...
	        ext-LayoutTool ext-AITask ext-JSONL ext-Timeline ext-Ask`,
...
| \`core/Sidebar\` | 6 |`);
		...
		md.details(import.meta, "readme.md", "Design record — why this is a snapshot, not a standing page");
	}
});
