...
- [`doc/data-children.md`](/framework/core/Page/doc/data-children/) — **proposed, not applied** (2026-09-13): children that live in data. `children` as a **function** core awaits once — which deletes the two overrides Make and JSON pages each hand-wrote, and the "Chaining cycle detected for promise" guard with them — and why a core `redraw()` is **refuted**
