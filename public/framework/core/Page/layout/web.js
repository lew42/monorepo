 ...
 *
 *     layout(site){ site.topbar(); site.hero(); site.sections(4); site.footer(); }
 *
 * `detail.js` hands `site` to every `layout()`, so no layout page imports this
 * file. A variant parameterises instead of copying: `web({ topics: "…" })`.
 */
