...
**The source shown is the `tree` function, not the file.** Mike, 2026-08-12: the
...
**Code as a lesson is formatted like documentation.** Mike, on the inline object
