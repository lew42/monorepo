...
preview_link(nav)                       // the link — icon + label`);
    ...
    card: "two",            // "two" | "tall" | "big" — its footprint on the wall
		...
		md("Fourteen of these running at once: the [Overview](/framework/core/Page/old/overview/) rail — every card in it is a live tree, drawn by `preview()`.");
		...
		md("Next: [Shell](/framework/core/Page/old/shell/) — the knobs on all of it, ending in your own app.");
	}
});
