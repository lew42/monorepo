...
| **A link in prose** | exactly one next step | always — every page should end with one |`);
		...
		md("More arrangements, live: the [Overview](/framework/core/Page/overview/) rail — a dashboard of unequal cards, a scrolling strip, and three whole sites assembled from these same pieces.");

		md("Next: [Children](/framework/core/Page/children/) — how the tree behind all of this is defined.");
	}
});
