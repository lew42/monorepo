...
export default new Page({
	...
	// ALL LAZY. Not one of these three is imported until you walk to it — watch
	// the console: the import line appears on the click, never on this load.
	children: "replace columns tabs dynamic full",
