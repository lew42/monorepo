// Dev-only sub-site server for new/1. Not part of the deployed site.
//
//   node public/framework/core/new/1/server.js        (port 8300)
//
...
// a lazily-imported /docs/intro/ be a real url with no file behind it.
...
class OneServer extends Server {
	...
	listen(port = process.env.PORT || 8300, host = "0.0.0.0"){
...
OneServer.use(DevSocket);

new OneServer();

console.log(`new/1 → http://localhost:${process.env.PORT || 8300}/`);
