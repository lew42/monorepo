...
/* Container: /imagine/'s column row, one `full` screen. Size: 1956 / 1210 at 3440,
   1036 / 641 at 1920, two bands at 400. Own layout: two regions, weights 61.8 and 38.2.
...
export default new Deck({
	...
	content(){
		...
		quiet(38.2, () => notes("The minor share is not small", [
			"At 3440 it is **1210px** — wider than a whole 40em measure, and wider than most of this site's reading columns.",
			"So the support is a **capped block inside its region**, not a column of 1210px prose. The region decides the room; the text decides the measure.",
