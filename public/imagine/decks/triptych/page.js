...
import { Deck, region, quiet, statement, list, notes, stack, slices, base } from "../deck.js";

/* Container: /imagine/'s column row, one `full` screen. Size: 791 / 1583 / 791 at 3440,
   419 / 838 / 419 at 1920, three bands at 400. Own layout: three regions, 25 / 50 / 25.
...
export default new Deck({
	...
	content(){
		...
		quiet(25, () => notes("What the flanks cost", [
			"At 1920 a flank is **419px** — a real rail, and the list beside this text is at its natural width there.",
			"At 3440 it is **791px**, which is past what a row of labels can fill. The list caps itself at 26em and the leftover becomes a margin; that is the fix, not a wider row.",
