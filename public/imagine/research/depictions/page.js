...
export default new Page({
	...
	content(){
		...
		md("Eight famous claims that ancient art depicts visitors or their machines, read against what archaeologists, art historians and the cultures themselves actually say. Every subject gets both readings, each sourced and labeled **established** / **contested** / **fringe** / **speculation** — and ends with what would settle it. Raw research trail: [`log.jsonl`](./log.jsonl), 40 entries, 35 sources.");
