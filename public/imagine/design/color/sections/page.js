 ...
 * there is no page grid — `wide` is meaningless, prose is capped at `--measure`, and the
 * two walls are divs, so the cap does not reach them. Size: `full`, the word every
 * sibling under /imagine/design/ wears. Own layout: `.grid.auto` with `--column: 19rem` —
