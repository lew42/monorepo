...
const THEMES = [
	...
	["oled",     "The mirror. Pure #000 / pure #fff, hairlines, no shadow in either mode."],
...
const column = ([name, why]) => ({
	...
	content(){
		...
		md("**Everything it declares** — read out of the stylesheet, not retyped:");
		tokens(name);
	},
});
	...
	children: [
...

		{
			...
			content(){
				...
				md("**What I would cut first:** `bloom`. It is the least distinguishable tile on the wall at a glance and it costs the most to maintain — the only theme carrying a full second syntax palette.");
			},
		},
	],
});
