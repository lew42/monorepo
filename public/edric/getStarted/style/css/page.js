import { Page, p, pre, hr } from "/app.js";

app.stylesheet("/edric/getStarted/style/css/demo.css");

export default new Page({
	meta: import.meta,
	title: "Normal CSS",
	description: "Write, load, and use a real stylesheet alongside the framework.",
	...
	content(){
		...
		p("1. Write a `.css` file. This page's demo lives at `/edric/getStarted/style/css/demo.css`:").ac("mb");
...
@media (max-width: 30em) {
    .demo-highlight {
		...
		pre(`app.stylesheet("/edric/getStarted/style/css/demo.css");`).ac("pad mb").style({ background: "var(--bg)", color: "white", "border-radius": "0.3em" });
