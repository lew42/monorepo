...
Open [/layouts/labs/sections/](/layouts/labs/sections/) — every idea below is one section on that page,
saying itself in its own left column.

## Use

```js /layouts/labs/sections/page.js
import { SectionsBand, SectionsStack } from "/layouts/labs/sections/sections.js";
...
- [Overview](/layouts/labs/sections/) — the ideas, one section each ·
  [full screen](/layouts/labs/sections/full/) ·
  [a stack of templates](/layouts/labs/sections/stack/) ·
  [with nav](/layouts/labs/sections/nav/)
- [`doc/decisions.md`](./doc/decisions.md) — what this was to `/imagine/layouts/` (deleted
  2026-09-18) and what it is to the paging vocabulary, the sticky measurements, the
  four-column answer, what is open
