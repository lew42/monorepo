...
/* ── ONE SECTION ───────────────────────────────────────────────────────────────
   ...
   optional head above them and an optional foot below. It is `/imagine/layouts/`'s
   3-column card (that realm was deleted 2026-09-18) made into a first-class, stackable
   thing: that card was a fixed intro | stage | readout, this is any number of columns,
   any distribution, any colour, stacked down a page or filling a screen.
...
/* A clickable that is not a `<button>`: the site theme styles every button as a small
   ...
   own specificity. Restated from `/imagine/layouts/system.js` (deleted 2026-09-18) rather
   than imported, for the reason that file gave — importing across realms drags the other
...
export class SectionsBand extends View {
	...
	measure(){
		...
		/* A sticky or inner-scrolling SIDEBAR wants the height of the viewport it
		   ...
		   overflowed its column by 90px (measured 2026-09-05, /layouts/labs/sections/full/).
