		...
		new SectionsStack({ classes: "bleed", space: "gap", bands(){
			...
			new SectionsBand({
				...
				head: () => {
					...
					link("/layouts/labs/sections/full/", "as one full screen");
					link("/layouts/labs/sections/stack/", "a stack of templates");
					link("/layouts/labs/sections/nav/", "with nav");
				},
			...
			new SectionsBand({
				...
				side: () => {
					...
					link("/layouts/labs/sections/full/", "the other way: a full screen where the middle scrolls");
				},
			...
			new SectionsBand({
				...
				pin: () => { link("/layouts/labs/sections/nav/", "the nav page"); span.c("sections-note", "pinned"); },
			});
			...
			new SectionsBand({
				...
				aside: () => {
					...
					link("/layouts/", "the numbered layouts this came from");
