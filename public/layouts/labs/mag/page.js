...
/* THE COVER — /layouts/labs/mag/, and the first thing a reader sees.
...
export default new Page({
	...
	// does not put a second link on the poster. It only makes `/layouts/labs/mag/doc/`
	...
	column(host){
		return div.c("page-column-body mag-sheet").ac("page-column-" + this.width).append(() => {
			...
			// OUTSIDE the cover's own `<a>` on purpose — the whole cover is one
			// click target, and a `?` nested inside it would fire the link too.
