# Decisions — /layouts/labs/mag/

The record for the magazine: what was chosen, what it was measured against, and what was
tried and dropped. The summary is [`readme.md`](/layouts/labs/mag/readme/).
...
(`lew42:/layouts/labs/mag/contents/`), one array of slugs, so "N of 6" is a `Set.size` rather than
...
**Fixed: `/layouts/labs/mag/doc/` 404'd outright**, and `readme.md` and `decisions.md` linked to
...
`/layouts/labs/mag/doc/decisions/` and `/layouts/labs/mag/readme/`; the whole readme ⇄ decisions
