...
/* ── layout, answered before the first factory call ────────────────────────────
   ...
   `/layouts/labs/mag/doc/` had no `page.js`, so it 404'd outright, and the two links
...
export default new Page({
	...
	content(){
		md("**The long form for [the magazine](/layouts/labs/mag/).** The cover and the issue show you the thing; this writes down why it is built the way it is, what was measured, and what was rejected.");
		...
		md("The short version is the [readme](/layouts/labs/mag/readme/).");
	},
});
