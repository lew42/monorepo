...
/* The one long note behind blogx, given a real url. `route()`, not `children:` — a
   ...
   ⚠ Undeclared on purpose: a link straight to `/layouts/labs/blogx/doc/decisions/` from
...
export default new Page({
	...
	content(){
		md("The working notes behind blogx: [Decisions](/layouts/labs/blogx/doc/decisions/) — every measurement, what was rejected, and what is left for the owner.");
	},
});
