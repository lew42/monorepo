...
The first six wrap the **same document**, so the chrome is the only thing that changes between them. And every shell's chrome links to every other shell, so once you're inside, switching between them IS the demo. [The findings](/layouts/labs/shells/readme/).`);
