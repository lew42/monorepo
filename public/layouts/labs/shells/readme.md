...
```js /layouts/labs/shells/left/page.js
...
Open [/layouts/labs/shells/](/layouts/labs/shells/) and click a card — each one is now a real
...
- **Inner chrome is a RULE; outer chrome is a FILL.** Same paper, a hairline, one type step
  ...
  outer chrome wearing a disguise. [`doc/decisions.md`](/layouts/labs/shells/doc/decisions/)
...
- [`doc/decisions.md`](/layouts/labs/shells/doc/decisions/) — every measurement, what was
