...
/* ── layout, answered before the first factory call ────────────────────────────
   ...
   `/layouts/labs/shells/doc/` had no `page.js`, so `/layouts/labs/shells/doc/decisions/`
   ...
   under /layouts/labs/shells/, and `decisions` has no page.js of its own to answer
   that probe with. */
...
export default new Page({
	...
	content(){
		md("**The long form for [Shells](/layouts/labs/shells/).** The lab shows you the ten shapes; [Decisions](/layouts/labs/shells/doc/decisions/) writes down why the grid is one template, what was measured, and what was rejected — start there before you change anything.");

		md("The short version is the [readme](/layouts/labs/shells/readme/).");
	},
});
