...
export default new Page({
	...
	content(){
		...
		md("A click either **replaces** what you were looking at, or **joins** it and the two split the space evenly — that's the whole vocabulary. Each card shows the shape it builds and the number it measured; the [readme](/layouts/labs/screens/readme/) has the caveats.");
