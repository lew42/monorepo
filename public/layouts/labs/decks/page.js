...
| **list** | **does not scale** — a row is its label | a fixed track (\`small\`), never a share |`);
		...
		md("Every verdict, and the widths behind it: [readme](/layouts/labs/decks/readme/) · [the content-kind map](/layouts/labs/decks/doc/regions/) · [decisions](/layouts/labs/decks/doc/decisions/).");
	},
});
