...
/* PRESENTATIONAL LAYOUTS — a screen cut into regions, and what belongs in each.
   ...
   This lab stands on /layouts/labs/screens/, which found the two words a whole screen is
...
export class Deck extends Page {
	...
	/* One screen: the slice, and an optional strip under it. Core's column head and its
	   automatic nav rows are left out for the reason /layouts/labs/screens/ left them out —
...
/* ── the keyboard ───────────────────────────────────────────────────────────
   ...
   the links. Three ⚠s, all three measured on /layouts/labs/screens/deck/ (2026-08-29)
