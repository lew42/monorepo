...
[`/layouts/labs/screens/`](/layouts/labs/screens/) already found the two words a whole screen is made of
...
This is [`/layouts/labs/screens/uneven/`](/layouts/labs/screens/uneven/)'s own finding — *a basis is a
...
[`/layouts/labs/screens/divide/`](/layouts/labs/screens/divide/)'s. Two cuts for one idea, so one goes.
...
- **A 90 / 10 spine.** [`/layouts/labs/screens/read/`](/layouts/labs/screens/read/) already owns the
...
- **Kept: a real screenshot of each `.decks-slice` replaces the abstract `diagram()` cut.**
  ...
  now it is a Playwright still of the real slide (`public/layouts/labs/decks/thumbs/*.jpg`,
