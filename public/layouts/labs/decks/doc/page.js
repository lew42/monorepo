...
/* The two long notes behind decks, given real urls. `route()`, not `children:` — a
   ...
   ⚠ Undeclared on purpose: links straight to `/layouts/labs/decks/doc/regions/` and
     `/layouts/labs/decks/doc/decisions/` from readme.md and page.js are what make these
...
export default new Page({
	...
	content(){
		md("The working notes behind decks: [Regions](/layouts/labs/decks/doc/regions/) — the content-kind map. [Decisions](/layouts/labs/decks/doc/decisions/) — every measurement, what was rejected, and what shipped.");
	},
});
